...
create table if not exists public.coach_micro_actions (
  ...
  coins_awarded integer default 0 check (coins_awarded >= 0),
...
create table if not exists public.coach_gamification_stats (
  ...
  total_reported integer default 0 check (total_reported >= 0),
  ...
  current_review_streak integer default 0 check (current_review_streak >= 0),
  longest_review_streak integer default 0 check (longest_review_streak >= 0),
